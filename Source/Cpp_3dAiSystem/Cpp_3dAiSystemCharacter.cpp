...
void ACpp_3dAiSystemCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ACpp_3dAiSystemCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACpp_3dAiSystemCharacter::Move);
...
void ACpp_3dAiSystemCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACpp_3dAiSystemCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACpp_3dAiSystemCharacter::SetupStimulusSource() {
